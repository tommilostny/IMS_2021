 ...
 * You can edit doxygen.config to improve it.
 *
 */
...
//! \example examples/ball.cc           Bouncing ball example
//! \example examples/ball2.cc          Bouncing ball example
//! \example examples/bessel.cc
//! \example examples/ctest.cc
//! \example examples/heating.cc        Relay example
//! \example examples/lorenz.cc         Lorenz equation
//! \example examples/model2.cc         Queuing system
//! \example examples/model2-timeout.cc
//! \example examples/multiexp.cc       Queuing system, multiple experiments
//! \example examples/rc.cc             Electrical RC circuit
//! \example examples/rlc.cc
//! \example examples/test3D.cc
//! \example examples/wheel.cc          mass+spring+damper
//! \example examples/wheel2.cc         ..., multiple experiments
...
/// is used for algebraic loop checking in continuous blocks
///
inline bool SimObject::TestAndSetFlag(bool new_value, unsigned mask) {
    bool old_value = (_flags & mask)!=0;
    if(new_value)
        _flags |=  mask;
    else
        _flags &= ~mask;
